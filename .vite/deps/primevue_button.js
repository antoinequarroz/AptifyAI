...
var script5 = {
  ...
  computed: {
    ...
    dataP: function dataP2() {
      return cn(_defineProperty7(_defineProperty7(_defineProperty7(_defineProperty7(_defineProperty7(_defineProperty7(_defineProperty7(_defineProperty7(_defineProperty7(_defineProperty7({}, this.size, this.size), "icon-only", this.hasIcon && !this.label && !this.badge), "loading", this.loading), "fluid", this.hasFluid), "rounded", this.rounded), "raised", this.raised), "outlined", this.outlined || this.variant === "outlined"), "text", this.text || this.variant === "text"), "link", this.link || this.variant === "link"), "vertical", (this.iconPos === "top" || this.iconPos === "bottom") && this.label));
    },
    dataIconP: function dataIconP() {
      return cn(_defineProperty7(_defineProperty7({}, this.iconPos, this.iconPos), this.size, this.size));
    },
    dataLabelP: function dataLabelP() {
      return cn(_defineProperty7(_defineProperty7({}, this.size, this.size), "icon-only", this.hasIcon && !this.label && !this.badge));
    }
  },
  components: {
    SpinnerIcon: script3,
